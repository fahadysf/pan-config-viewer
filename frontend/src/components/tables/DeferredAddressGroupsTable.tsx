...
const AddressGroupsTable = lazy(() => 
  import('./AddressGroupsTable').then(module => ({
    default: module.AddressGroupsTable
  }))
)
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
      ...
      <div className="text-center">
        <p className="text-sm font-medium text-gray-900">Loading address groups...</p>
...
export function DeferredAddressGroupsTable() {
