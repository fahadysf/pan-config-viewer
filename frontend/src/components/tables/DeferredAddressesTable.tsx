...
const AddressesTable = lazy(() => 
  import('./AddressesTable').then(module => ({
    default: module.AddressesTable
  }))
)
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
      ...
      <div className="text-center">
        <p className="text-sm font-medium text-gray-900">Loading addresses...</p>
...
export function DeferredAddressesTable() {
