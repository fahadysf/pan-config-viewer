...
const SecurityPoliciesTable = lazy(() => 
  import('./SecurityPoliciesTable').then(module => ({
    default: module.SecurityPoliciesTable
  }))
)
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
      ...
      <div className="text-center">
        <p className="text-sm font-medium text-gray-900">Loading security policies...</p>
...
export function DeferredSecurityPoliciesTable() {
